			...
			<table class="table-fill">
				<thead>
					<tr>
						...
						<th class="text-left">Event Start</th>
						<th class="text-left">Event End</th>
						<th class="text-left">Guest</th>
					</tr>
				</thead>
				<tbody class="table-hover">
					<tr>
						<td class="text-left">Kwartam</td>
						<td class="text-left">Cottage 1</td>
						<td class="text-left">Birthday</td>
						<td class="text-left">2022-08-21</td>
						<td class="text-left">2022-08-23</td>
            ...
            <div class="col-lg-6 col-xl-3 mb-4">
                <div class="card bg-info text-white h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="me-3">
                                <div class="text-white-75 small">Pending Reservation</div>
